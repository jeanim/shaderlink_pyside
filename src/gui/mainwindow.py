...
class MainWindow(QtGui.QMainWindow):
    ...
    def attachViewsToModel(self):
        self.shaderLink.nodeLibraryLoaded.connect(self.nodeLibraryViewer.controller.onNodeLibraryLoaded)
        # self.connect(self.shaderLink, QtCore.SIGNAL('nodeLibraryLoaded'),
        #              self.nodeLibraryViewer.controller.onNodeLibraryLoaded)

        self.shaderLink.renderingSettingsLoaded.connect(self.renderingPanel.controller.onRenderingSettingsLoaded)
        ...
        self.renderingPanel.controller.renderingSettingsChanged.connect(self.controller.onRenderingSettingsChanged)
        ...
        self.shaderLink.nodeAdded.connect(self.renderingPanel.controller.onNodeAdded)
        # self.connect(self.shaderLink, QtCore.SIGNAL('nodeAdded'),
        #              self.renderingPanel.controller.onNodeAdded)

        self.shaderLink.nodeAdded.connect(self.controller.onNodeAdded)
        # self.connect(self.shaderLink, QtCore.SIGNAL('nodeAdded'),
        #              self.controller.onNodeAdded)

        self.shaderLink.nodeRemoved.connect(self.renderingPanel.controller.onNodeRemoved)
        # self.connect(self.shaderLink, QtCore.SIGNAL('nodeRemoved'),
        #              self.renderingPanel.controller.onNodeRemoved)

        self.shaderLink.nodeLoaded.connect(self.controller.onNodeLoaded)
        # self.connect(self.shaderLink, QtCore.SIGNAL('nodeLoaded'),
        #              self.controller.onNodeLoaded)

        self.commandProcessor.commandExecuted.connect(self.controller.onCommandExecuted)
        # self.connect(self.commandProcessor, QtCore.SIGNAL('commandExecuted'),
        #              self.controller.onCommandExecuted)

        self.commandProcessor.copyCommandChanged.connect(self.controller.onCopyCommandChanged)
        ...
        scene.selectionChanged.connect(self.controller.onSelectionChanged)
        # self.connect(scene, QtCore.SIGNAL('selectionChanged()'),
        #              self.controller.onSelectionChanged)
        scene.selectionChanged.connect(self.nodePropertyViewer.onSelectionChanged)
        # self.connect(scene, QtCore.SIGNAL('selectionChanged()'),
        #              self.nodePropertyViewer.onSelectionChanged)
        self.commandProcessor.dirtyStateChanged.connect(self.controller.onDirtyStateChanged)
