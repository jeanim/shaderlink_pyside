...
class ShaderBuilder(object):
    ...
    def buildRib(self):
        ...
        if self.renderSettings['Preview']:
            ribListing = ribListing.replace('$(Width)', '180')
            ribListing = ribListing.replace('$(Height)', '180')
...
class PreviewBuilder(object):
    ...
    def buildRib(self):
        ...
        ribListing = ribListing.replace('$(Width)', str(int(self.gfxNode.gfxNodeBuilder.previewPixmapWidth)))
        ribListing = ribListing.replace('$(Height)', str(int(self.gfxNode.gfxNodeBuilder.previewPixmapHeight)))
        ribListing = ribListing.replace('$(AspectRatio)', '1')
