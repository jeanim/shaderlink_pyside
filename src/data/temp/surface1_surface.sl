...
float powF0_outValue = pow(compC0_red, compC1_red);
// END NODE powF0 
...
float powF1_outValue = pow(compC0_green, compC1_green);
// END NODE powF1 

// START NODE color0 

color color0_outColor = color(powF0_outValue, powF1_outValue, powF2_outValue);
// END NODE color0 

// START NODE surface1 
color surface1_Oi = color(1.000,1.000,1.000);

Ci = color0_outColor; Oi = surface1_Oi;
// END NODE surface1 
