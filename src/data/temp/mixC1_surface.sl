...
// START NODE invertColor2 

color invertColor2_invertedColor = color(1 - comp(mixC0_outColor, 0),
												  1 - comp(mixC0_outColor, 1),
												  1 - comp(mixC0_outColor, 2));
// END NODE invertColor2 

// START NODE colorToFloat3 

float colorToFloat3_outFloat = (comp(invertColor2_invertedColor, 0) + comp(invertColor2_invertedColor, 1) + comp(invertColor2_invertedColor, 2)) / 3;
// END NODE colorToFloat3 

// START NODE plastic0 
float plastic0_inOpacity = 1.000;
float plastic0_ka = 1.000;
float plastic0_kd = 0.400;
float plastic0_roughness = 0.060;

normal plastic0_Nf = faceforward(normalize(N), I);
color plastic0_outColor = marble0_outColor * (plastic0_ka * ambient() +
                    plastic0_kd * diffuse(plastic0_Nf)) + marble0_outColor * colorToFloat3_outFloat *
...
color mixC1_outColor = mix((plastic0_outColor), (plastic1_outColor), (threshold1_outValue));
// END NODE mixC1 

Ci = mixC1_outColor; Oi = 1.0;}
