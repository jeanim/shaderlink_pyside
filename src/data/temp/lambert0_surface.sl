...
// START NODE lambert0 
color lambert0_SurfaceColor = color(1.000,0.643,0.244);
...
float lambert0_translucence = 0.000;
 ...
 color lambert0_Ia= ambient() + moon0_outColor;
